...
public class FindLengthOfLongestSubstringOfString {
	static void longestSubstring(String inputString) {
		...
		System.out.println("The longest substring is: " + long_str);
		System.out.println("The longest Substring length is: " + str_length);
	}
